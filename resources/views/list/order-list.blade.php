@extends('layouts.app')
@section('content')
<div x-data="{modalUpdate:false, modalDetail:false, orderData:{id:false,customer_name:false,customer_phone:false,customer_address:false,qty:false,name:false,price:false,weight:false,total:false}}">

<div class="flex space-x-1 justify-around" x-data="{modal_{{$id}}:false}">
    <a href="/animal/detail?id={{$id}}" class="p-1 text-teal-600 hover:bg-teal-600 hover:text-white rounded">
    ...
    <a href = "/animal/edit?id={{$id}}" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path></svg>
    </a>

    <a class="p-1 text-red-600 hover:bg-red-600 hover:text-white rounded" @click="modal_{{$id}} = !modal_{{$id}}">
      ...
      <div class="relative sm:w-3/4 md:w-1/2 lg:w-1/3 mx-2 sm:mx-auto my-10 opacity-100">
        ...
        >
          ...
          <main class="p-2">
                ...
                <div>
                  <div>Are you sure want to delete this animal ? : </div>
